 ...
 * @license  GPL 2.0
 * @version   0.1.0
 * @decription  RESPONSE类，包含处理每一次请求的相应方法和返回信息。
 * @modify 2016-08-02
 **/
 ...
 * @throws YunException When an unknown status code is reached.
 */
	public function statusCode($code = null) {
		...
		if (!isset($this->_statusCodes[$code])) {
			throw new YunException(__d('Unknown status code'));
		}
