...
class FilesystemManager implements FactoryContract
{
    ...
    public function createLocalDriver(array $config)
    {
        ...
        return $this->adapt($this->createFlysystem(new LocalAdapter(
            $config['YUN_ROOT'], LOCK_EX, $links, $permissions
        ), $config));
    }
    ...
    public function createFtpDriver(array $config)
    {
        $ftpConfig = Arr::only($config, [
            'host', 'username', 'password', 'port', 'YUN_ROOT', 'passive', 'ssl', 'timeout',
        ]);
    ...
    public function createS3Driver(array $config)
    {
        ...
        $root = isset($s3Config['YUN_ROOT']) ? $s3Config['YUN_ROOT'] : null;
    ...
    public function createRackspaceDriver(array $config)
    {
        ...
        $root = isset($config['YUN_ROOT']) ? $config['YUN_ROOT'] : null;
